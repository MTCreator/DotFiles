...
#+BEGIN_SRC emacs-lisp
  (use-package exwm
    ...
    :config
      ...
      (exwm-input-set-key (kbd "s-&") (lambda() (interactive) (exwm-workspace-switch-create 1)))
      (exwm-input-set-key (kbd "s-é") (lambda() (interactive) (exwm-workspace-switch-create 2)))
      (exwm-input-set-key (kbd "s-\"") (lambda() (interactive) (exwm-workspace-switch-create 3)))
      (exwm-input-set-key (kbd "s-'") (lambda() (interactive) (exwm-workspace-switch-create 4)))
      (exwm-input-set-key (kbd "s-(") (lambda() (interactive) (exwm-workspace-switch-create 5)))
      (exwm-input-set-key (kbd "s-§") (lambda() (interactive) (exwm-workspace-switch-create 6)))
      (exwm-input-set-key (kbd "s-è") (lambda() (interactive) (exwm-workspace-switch-create 7)))
      (exwm-input-set-key (kbd "s-!") (lambda() (interactive) (exwm-workspace-switch-create 8)))
      (exwm-input-set-key (kbd "s-ç") (lambda() (interactive) (exwm-workspace-switch-create 9)))
      (exwm-input-set-key (kbd "s-à") (lambda() (interactive) (exwm-workspace-switch-create 10)))
      ...
      ;;multi-monitor
      (require 'exwm-randr)
      (setq exwm-randr-workspace-output-plistplist '(1 "eDP1" 2 "DP1"))
      (add-hook 'exwm-randr-screen-change-hook
          (lambda ()
            (start-process-shell-command
             "xrandr" nil "xrandr --output DP1 --auto --above eDP1")))
      (exwm-randr-enable)      
      ...
      ;;xmodmap
      (shell-command "xmodmap ~/.config/x/Xmodmap")
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun mtc/launch-xfce-term ()
    (interactive)
    (exwm-async-run "xfce4-terminal"))

  (defun mtc/launch-discord ()
    (interactive)
    (exwm-async-run "discord"))

  (defun mtc/launch-browser ()
    (interactive)
    (exwm-async-run "chromium"))

  (defun mtc/lock-screen ()
    (interactive)
    (exwm-async-run "lockscreen"))
...
#+BEGIN_SRC emacs-lisp
  (global-set-key (kbd "<s-return>") 'mtc/launch-xfce-term)
  (global-set-key (kbd "s-q") 'mtc/launch-browser)
  (global-set-key (kbd "s-l") 'mtc/lock-screen)
#+END_SRC

** Audio controls
This is a set of bindings to XF86 keys that invokes pulsemixer with the correct parameters
*** Volume modifier
#+BEGIN_SRC emacs-lisp
(defconst volumeModifier "5")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (defun mtc/take-screenshot ()
    ...
    (global-set-key (kbd "<C-print>") 'mtc/take-screenshot)
#+END_SRC

*** Screenshotting a region
#+BEGIN_SRC emacs-lisp
  (defun mtc/take-screenshot-region ()
    ...
    (global-set-key (kbd "<print>") 'mtc/take-screenshot-region)
#+END_SRC
** Default browser
#+BEGIN_SRC emacs-lisp
